...
- (tests) [#1434](https://github.com/evmos/evmos/pull/1434) Set default staking denom to `avce` in `evm` and `feemarket` tests
...
- (cmd) [\#1121](https://github.com/evmos/evmos/pull/1121) Fix `vinced version` to show either tag or last commit.
...
- (cmd) [\#543](https://github.com/evmos/evmos/pull/543) Update mainnet default `min-gas-price` to `0.0025avce`.
