...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "vince.recovery.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "vince.recovery.v1.V2Params")
}

func init() { proto.RegisterFile("vince/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
