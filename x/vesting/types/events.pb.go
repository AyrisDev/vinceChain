...
// source: vince/vesting/v1/events.proto
...
func init() {
	proto.RegisterType((*EventCreateClawbackVestingAccount)(nil), "vince.vesting.v1.EventCreateClawbackVestingAccount")
	proto.RegisterType((*EventClawback)(nil), "vince.vesting.v1.EventClawback")
	proto.RegisterType((*EventUpdateVestingFunder)(nil), "vince.vesting.v1.EventUpdateVestingFunder")
}

func init() { proto.RegisterFile("vince/vesting/v1/events.proto", fileDescriptor_48ea095c8e21d4cd) }
