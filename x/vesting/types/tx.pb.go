...
func init() {
	...
	proto.RegisterType((*MsgUpdateVestingFunder)(nil), "vince.vesting.v1.MsgUpdateVestingFunder")
	proto.RegisterType((*MsgUpdateVestingFunderResponse)(nil), "vince.vesting.v1.MsgUpdateVestingFunderResponse")
	proto.RegisterType((*MsgConvertVestingAccount)(nil), "vince.vesting.v1.MsgConvertVestingAccount")
	proto.RegisterType((*MsgConvertVestingAccountResponse)(nil), "vince.vesting.v1.MsgConvertVestingAccountResponse")
}

func init() { proto.RegisterFile("vince/vesting/v1/tx.proto", fileDescriptor_d5db113bc0c7240c) }
...
func (c *msgClient) UpdateVestingFunder(ctx context.Context, in *MsgUpdateVestingFunder, opts ...grpc.CallOption) (*MsgUpdateVestingFunderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vince.vesting.v1.Msg/UpdateVestingFunder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ConvertVestingAccount(ctx context.Context, in *MsgConvertVestingAccount, opts ...grpc.CallOption) (*MsgConvertVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vince.vesting.v1.Msg/ConvertVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateVestingFunder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vince.vesting.v1.Msg/UpdateVestingFunder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ConvertVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vince.vesting.v1.Msg/ConvertVestingAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
