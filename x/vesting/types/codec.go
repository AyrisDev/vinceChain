...
const (
	// Amino names
	clawback                     = "vince/MsgClawback"
	createClawbackVestingAccount = "vince/MsgCreateClawbackVestingAccount"
	updateVestingFunder          = "vince/MsgUpdateVestingFunder"
	convertVestingAccount        = "vince/MsgConvertVestingAccount"
)
