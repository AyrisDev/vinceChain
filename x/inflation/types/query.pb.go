...
func init() {
	...
	proto.RegisterType((*QueryCirculatingSupplyRequest)(nil), "vince.inflation.v1.QueryCirculatingSupplyRequest")
	proto.RegisterType((*QueryCirculatingSupplyResponse)(nil), "vince.inflation.v1.QueryCirculatingSupplyResponse")
...
func init() { proto.RegisterFile("vince/inflation/v1/query.proto", fileDescriptor_91b9f1b5d47c7fd7) }
...
func (c *queryClient) CirculatingSupply(ctx context.Context, in *QueryCirculatingSupplyRequest, opts ...grpc.CallOption) (*QueryCirculatingSupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vince.inflation.v1.Query/CirculatingSupply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_CirculatingSupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vince.inflation.v1.Query/CirculatingSupply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
