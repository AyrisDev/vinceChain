...
import (
	...
	"github.com/AyrisDev/vinceChain/v12/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "avce"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on vince need to have their tokens in the
