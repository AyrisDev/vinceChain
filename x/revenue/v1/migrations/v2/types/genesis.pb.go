...
// source: vince/revenue/v1/genesis.proto
...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "vince.revenue.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "vince.revenue.v1.V2Params")
}

func init() { proto.RegisterFile("vince/revenue/v1/genesis.proto", fileDescriptor_649d64d9c3438055) }
