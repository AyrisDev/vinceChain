...
const DefaultFeeAmt = int64(150_000_000_000_000_000) // 0.15 vince
...
func SendMsgs(chain *ibctesting.TestChain, feeAmt int64, msgs ...sdk.Msg) (*sdk.Result, error) {
	...
	if vinceChain, ok := chain.App.(*app.Vince); ok {
		bondDenom = vinceChain.StakingKeeper.BondDenom(chain.GetContext())
	} else {
