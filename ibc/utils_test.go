...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/avce",
			"10",
			sdk.Coin{Denom: "avce", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped avce coin",
			"avce",
			"10",
			sdk.Coin{Denom: "avce", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped avce coin",
			"transfer/channel-0/avce",
			"10",
			sdk.Coin{Denom: teststypes.avceIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
