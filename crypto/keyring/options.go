...
// AppName defines the Ledger app used for signing. vince uses the Ethereum app
...
var (
	...
	// LedgerDerivation defines the vince Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.vinceLedgerDerivation()
