...
import (
	...
	cryptocodec "github.com/AyrisDev/vinceChain/v12/crypto/codec"
	enccodec "github.com/AyrisDev/vinceChain/v12/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("vince", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, vincetypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, vincetypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := hdwallet.MustParseDerivationPath(vincetypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of vince implementation
	...
	// Equality of Eth and vince implementation
	...
	// Inequality of wrong derivation path of Eth and vince implementation
