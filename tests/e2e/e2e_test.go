...
// TestUpgrade tests if an vince node can be upgraded from one version to another.
...
// TestCLITxs executes different types of transactions against an vince node
