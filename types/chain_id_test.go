...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "vince_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "vince_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "vince_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "vince_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "vince_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "vince_vince_1903-1", true, nil,
		},
		{
			"invalid epoch, undefined", "vince_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "vince_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
